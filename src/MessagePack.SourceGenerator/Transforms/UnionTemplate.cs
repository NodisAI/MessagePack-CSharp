...
namespace MessagePack.SourceGenerator.Transforms
{
 ...
 using (this.EmitNestingTypesAndNamespaces(this.Write)) { 
            ...
            #line default
            #line hidden
            this.Write("()\r\n\t\t{\r\n\t\t\tthis.typeToKeyAndJumpMap = new global::System.Collections.Generic.Dictionary<global::System.RuntimeTypeHandle, global::System.Collections.Generic.KeyValuePair<int, int>>(");
 ...
 for(var i = 0; i < Info.SubTypes.Length; i++) { var item = Info.SubTypes[i]; 
            ...
            this.Write("\t\t\t};\r\n\t\t\tthis.keyToJumpMap = new global::System.Collections.Generic.Dictionary<int, int>(");
