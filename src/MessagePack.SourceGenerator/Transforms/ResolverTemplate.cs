...
namespace MessagePack.SourceGenerator.Transforms
{
    ...
    public partial class ResolverTemplate : ResolverTemplateBase
    {
        ...
        {
            this.Write("\r\nusing MsgPack = global::MessagePack;\r\n\r\n[assembly: MsgPack::Internal.GeneratedAssemblyMessagePackResolverAttribute(typeof(");
 ...
 using (TransformUtilities.EmitNestingTypesAndNamespaces(this.ResolverName, this.Write)) { 
   ...
   if (constructedRegistrations.Length > 0) { 
            this.Write("\t\tprivate static readonly global::System.Collections.Generic.Dictionary<global::System.Type, int> closedTypeLookup = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(");
 ...
 for(var i = 0; i < constructedRegistrations.Length; i++) { 
   ...
   if (openGenericRegistrations.Length > 0) { 
            this.Write("\t\tprivate static readonly global::System.Collections.Generic.Dictionary<global::System.Type, int> openTypeLookup = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(");
 ...
 for(var i = 0; i < constructedRegistrations.Length; i++) { var x = constructedRegistrations[i]; 
   ...
   if (openGenericRegistrations.Length > 0) { 
            this.Write("\t\t\tif (t.IsGenericType && openTypeLookup.TryGetValue(t.GetGenericTypeDefinition(), out int openKey))\r\n\t\t\t{\r\n\t\t\t\tswitch (openKey)\r\n\t\t\t\t{\r\n");
